...
function Hero() {
  ...
  return (
    ...
    <div className="hero-content flex-col lg:flex-row-reverse gap-24">
        <Lottie loop animationData={heroData} play className='w-9/12' data-aos="fade-right"/>
      <div className='w-3/6' data-aos="fade-up">
        <h1 className="text-6xl font-bold">An <span className='innovative'>Innovative</span> it and Software consult center</h1>
        ...
        <button className="btn btn-primary text-white rounded-md">Get Started</button>
      </div>
    </div>
  </div>
  )
